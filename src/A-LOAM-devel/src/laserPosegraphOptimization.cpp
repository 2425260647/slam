...
int main(int argc, char **argv)
{
    ...
    // save directories 
	nh.param<std::string>("save_directory", save_directory, "/tmp/sc_aloam/"); // pose assignment every k m move 
    if (save_directory.empty())
        save_directory = "/tmp/sc_aloam/";
