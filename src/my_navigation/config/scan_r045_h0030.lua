...
POSE_GRAPH.optimization_problem.slip_high_threshold = 0.030000
POSE_GRAPH.optimization_problem.slip_low_threshold = 0.012000
...
POSE_GRAPH.optimization_problem.slip_lidar_reliability_min = 0.450000
