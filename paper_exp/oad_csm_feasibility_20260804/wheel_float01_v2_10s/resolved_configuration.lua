  ...
  trajectory_builder = {
    ...
    trajectory_builder_2d = {
      ...
      real_time_correlative_scan_matcher = {
        ...
        candidate_diagnostic_angular_search_window = 0.052360,
        candidate_diagnostic_enabled = true,
        candidate_diagnostic_linear_search_window = 1.000000,
        candidate_diagnostic_min_angular_separation = 0.034907,
        candidate_diagnostic_min_translation_separation = 0.200000,
        candidate_diagnostic_sampling_interval = 5.000000,
        linear_search_window = 0.150000,
        oad_angular_search_window = 0.349066,
        oad_coarse_to_fine_levels = 1.000000,
        oad_confirmation_angular_tolerance = 0.087266,
        oad_confirmation_count = 1.000000,
        oad_confirmation_translation_tolerance = 0.100000,
        oad_enabled = false,
        oad_linear_search_window = 0.150000,
        oad_max_candidates = 1.000000,
        oad_max_search_time_ms = 1.000000,
        oad_min_peak_margin = 0.000000,
        oad_min_score_gain = 0.000000,
        oad_peak_angular_separation = 0.087266,
        oad_peak_translation_separation = 0.100000,
        oad_weak_map_score_threshold = 0.000000,
        oad_wide_peak_margin = 0.000000,
