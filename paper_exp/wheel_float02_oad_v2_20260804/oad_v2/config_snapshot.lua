...
csm.oad_peak_translation_separation = 0.15
csm.oad_peak_angular_separation = math.rad(5.)
csm.oad_confirmation_translation_tolerance = 0.10
csm.oad_confirmation_angular_tolerance = math.rad(5.)
